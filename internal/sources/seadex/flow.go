...
// MetadataURL enables AniList title/cover enrichment for changed items only.
// Empty disables enrichment, leaving AniList-ID titles.
type Flow struct{ MetadataURL string }
